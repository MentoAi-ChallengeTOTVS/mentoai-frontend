...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-dvh w-full items-stretch bg-neutro-background lg:h-dvh lg:overflow-hidden">
      <Sidebar
        activeHref={pathname}
        perfil={usuario.role}
      ...
      />
      <div className="flex min-h-dvh min-w-0 flex-1 flex-col items-stretch lg:min-h-0">
        ...
        <main className="flex min-h-0 min-w-0 flex-1 flex-col items-start gap-6 p-4 sm:p-6 lg:max-h-screen lg:overflow-y-auto lg:p-8">{children}</main>
      </div>
